                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($bdonor as $bd) {
                            $urlEdit = "index.php?controller=docgia&action=edit&madg=" . $bd['madg'];
                            $urlDelete = "index.php?controller=docgia&action=delete&madg=" . $bd['madg'];
                        ?>
                            <tr>
                                <!-- <th scope="row"><?php echo $bd['madg'] ?></th> -->
                                <td><?php echo $bd['madg'] ?></td>
                                ...
                                <td><a onclick="return confirm('Bạn chắc chắn muốn xóa không')" href="<?php echo $urlDelete ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
                        <?php
                        }
                        ?>
